<?php
function minimag_masonry_two( $atts ) {
		...
		<div class="container no-padding">
			...
			<div class="row blog-masonry-list">
				...
				while ( have_posts() ) : the_post();
					...
					elseif( $post_count == 6 ||  $post_count == 7 ) {
...
add_shortcode('minimag_masonry_two', 'minimag_masonry_two');
...
if( function_exists('vc_map') ) {
	...
	vc_map( array(
		'base' => 'minimag_masonry_two',
		'name' => esc_html__( 'Masonry 2', "minimag-toolkit" ),
		'class' => '',
