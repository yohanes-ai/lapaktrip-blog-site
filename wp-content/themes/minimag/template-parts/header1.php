...
?>
<!-- Header Section -->
<header class="container-fluid no-left-padding no-right-padding header_s header_s1<?php echo esc_attr( $header_css ); ?>">
	<!-- SidePanel -->
				...
				<div class="row">
					...
					<div class="<?php echo esc_attr($md_css); ?>">
						<ul class="top-right user-info">
							<li class="dropdown">
									<a class="dropdown-toggle" href="<?php echo wp_login_url(get_permalink()); ?>"><i class="pe-7s-user"></i></a> 
							</li>
							<li>
								<a href="#search-box" data-toggle="collapse"  class="search collapsed" title="<?php esc_html_e('Search',"minimag"); ?>">
