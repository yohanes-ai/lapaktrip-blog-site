<?php
function minimag_masonry_three( $atts ) {
	...
	<div class="container-fluid no-left-padding no-right-padding">
		...
		<div class="container">
			<div class="row">
				<div class="content-area col-sm-12 no-padding">
					<!-- Row -->
					<div class="row blog-masonry-list">
						...
						while ( have_posts() ) : the_post();
							...
							elseif($post_count == 4 || $post_count == 11 ) {
								$thumb  = 'minimag_370_370';
							}
							elseif($post_count == 5) {
								$thumb  = 'minimag_370_494';
							}
							elseif($post_count == 8 || $post_count == 10 ) {
							...
							?>
							<div class="col-lg-4 col-sm-6 blog-masonry-box 1">
								<div <?php post_class(); ?>>
									<?php
...
add_shortcode('minimag_masonry_three', 'minimag_masonry_three');
...
if( function_exists('vc_map') ) {
	...
	vc_map( array(
		'base' => 'minimag_masonry_three',
		'name' => esc_html__( 'Masonry 3', "minimag-toolkit" ),
		'class' => '',
