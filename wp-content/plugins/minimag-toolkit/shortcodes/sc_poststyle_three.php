<?php
function minimag_style_three( $atts ) {
	
	extract( shortcode_atts( array( 'sc_layout'=> 'one', 'posts_display' => '', 'post_by'=> 'random', 'select_cat'=> '', 'post_id'=> '', 'cat_ids'=> '', 'stick_post'=> '' ), $atts ) );
					...
					<?php
						...
						while ( have_posts() ) : the_post();
							...
							<div class="col-lg-12 col-md-12 col-sm-12">
								<div <?php post_class('blog-onecolumn') ?>>
									<?php
	...
	elseif( $sc_layout == "two" && have_posts() ) {
		?>
		<!-- Page Content -->
		<div class="container-fluid no-left-padding no-right-padding blog-one-col-no-sidebar">
			<!-- Container -->
			<div class="container">
				<div class="row justify-content-md-center">
					<!-- Content Area -->
					<div class="col-lg-10 col-md-6 content-area">
						<!-- Row -->
						<div class="row">
							<?php
								while ( have_posts() ) : the_post();
											...
											<?php
														...
														<div id="blog-carousel-<?php echo esc_attr(the_ID()); ?>" class="carousel slide" data-ride="carousel">
															<div class="carousel-inner" role="listbox">
																...
																foreach ( (array) get_post_meta( get_the_ID(), 'minimag_cf_post_gallery', 1 ) as $attachment_id => $attachment_url ) {
																	?>
																	<div class="carousel-item<?php if( $active == 1 ) { echo ' active'; } ?>">
																		<?php echo wp_get_attachment_image( $attachment_id, 'minimag_910_550' ); ?>
																	</div>
																	<?php
																	$active++;
																} ?>
												...
												if( has_post_thumbnail() && ( get_post_format() != "audio" && get_post_format() != "video" && get_post_format() != "gallery" ) ) {
													...
													<div class="entry-cover">
														...
														<a href="<?php the_permalink(); ?>">
															<?php the_post_thumbnail('minimag_910_550'); ?>
														</a>
													</div>
													<?php
												}
...
add_shortcode('minimag_style_three', 'minimag_style_three');
...
if( function_exists('vc_map') ) {
	...
	vc_map( array(
		'base' => 'minimag_style_three',
		'name' => esc_html__( 'Post 1 Column', "minimag-toolkit" ),
		'class' => '',
		"category" => esc_html__("Minimag Theme", "minimag-toolkit"),
		'params' => array(
			array(
				'type' => 'dropdown',
				'heading' => esc_html__( 'Select Options', "minimag-toolkit" ),
				'param_name' => 'sc_layout',
				'value' => array(
					esc_html__( 'Style 1', "minimag-toolkit" ) => 'one',
					esc_html__( 'Style 2', "minimag-toolkit" ) => 'two',
				),
			),
			array(
				"type" => "dropdown",
