<?php
function minimag_style_one( $atts ) {
	...
	elseif($sc_layout == "two") {
		?>
		<!-- Page Content -->
		<div class="container-fluid no-left-padding no-right-padding blog-paralle-post-no-sidebar post-single-center">
			<!-- Container -->
			<div class="container">
				<!-- Row -->
										...
										<?php
													...
													<div id="blog-carousel-<?php echo esc_attr(the_ID()); ?>" class="carousel slide" data-ride="carousel">
														<div class="carousel-inner" role="listbox">
															...
															foreach ( (array) get_post_meta( get_the_ID(), 'minimag_cf_post_gallery', 1 ) as $attachment_id => $attachment_url ) {
																?>
																<div class="carousel-item<?php if( $active == 1 ) { echo ' active'; } ?>">
																	<?php echo wp_get_attachment_image( $attachment_id, 'minimag_351_247' ); ?>
																</div>
																<?php
																$active++;
															} ?>
											...
											if( has_post_thumbnail() && ( get_post_format() != "audio" && get_post_format() != "video" && get_post_format() != "gallery" ) ) {
												...
												<div class="entry-cover">
													...
													<a href="<?php the_permalink(); ?>">
														<?php the_post_thumbnail('minimag_351_247'); ?>
													</a>
												</div>
												<?php
											}
...
add_shortcode('minimag_style_one', 'minimag_style_one');
...
if( function_exists('vc_map') ) {
	...
	vc_map( array(
		'base' => 'minimag_style_one',
		'name' => esc_html__( 'Post Style 1', "minimag-toolkit" ),
		'class' => '',
