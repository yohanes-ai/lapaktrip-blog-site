<?php
function minimag_carousel_five( $atts ) {
		...
		<div class="container-fluid no-left-padding no-right-padding slider-section slider-section6">
			...
			<div class="slider-carousel slider-carousel-6 center">
				...
				while ( $qry->have_posts() ) : $qry->the_post();
					...
					<div class="item">
						<div class="post-box">
							<?php the_post_thumbnail('minimag_700_600'); ?>
...
add_shortcode('minimag_carousel_five', 'minimag_carousel_five');
...
if( function_exists('vc_map') ) {
	...
	vc_map( array(
		'base' => 'minimag_carousel_five',
		'name' => esc_html__( 'Post Carousel 5', "minimag-toolkit" ),
		'class' => '',
