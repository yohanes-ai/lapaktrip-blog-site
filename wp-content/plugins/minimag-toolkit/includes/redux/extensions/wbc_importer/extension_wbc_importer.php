    ...
    class ReduxFramework_extension_wbc_importer {
        ...
        function add_importer_section() {
            ...
            $this->parent->sections[] = array(
               ...
               'desc'   => '<p class="description">'. apply_filters( 'wbc_importer_description', '<div class="intro-text"><p> Importing demo data (post, pages, images, theme settings, ...) is the easiest way to setup your theme. It will allow you to quickly edit everything instead of creating content from scratch. When you import the data, the following things might happen: </p><ul><li>No existing posts, pages, categories, images, custom post types or any other data will be deleted or modified.</li><li>Posts, pages, images, widgets and menus will get imported.</li><li>Please click on "Import Demo" button only once and wait, it can take a couple of minutes.</li></ul></div><div class="intro-text"><p>Before you begin, make sure all the required plugins are activated.</p></div>', "minimag-toolkit" ).'</p>',
