<?php
function minimag_carousel_six( $atts ) {
		...
		<div class="container-fluid no-left-padding no-right-padding slider-section slider-section7">
			...
			<div class="slider-carousel slider-carousel-7 center">
				...
				while ( $qry->have_posts() ) : $qry->the_post();
					...
					<div class="item">
						<div class="post-box">
							<?php the_post_thumbnail('minimag_1164_500'); ?>
...
add_shortcode('minimag_carousel_six', 'minimag_carousel_six');
...
if( function_exists('vc_map') ) {
	...
	vc_map( array(
		'base' => 'minimag_carousel_six',
		'name' => esc_html__( 'Post Carousel 6', "minimag-toolkit" ),
		'class' => '',
