...
?>
<!-- Header Section -->
<header class="container-fluid no-left-padding no-right-padding header_s header_s7<?php echo esc_attr($header_css); ?>">
	<!-- SidePanel -->
				...
				<div class="row">
					...
					<div class="<?php echo esc_attr($md_css); ?>">
						<ul class="top-right user-info">
							<li>
								<a href="#search-box9" data-toggle="collapse" class="search collapsed" title="<?php esc_html_e('Search',"minimag"); ?>">
