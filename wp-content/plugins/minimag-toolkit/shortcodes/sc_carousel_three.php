<?php
function minimag_carousel_three( $atts ) {
		...
		<div class="container-fluid no-left-padding no-right-padding slider-section">
			...
			<div class="slider-carousel-4">
				...
				while ( $qry->have_posts() ) : $qry->the_post();
					?>
					<div class="post-box">
						<?php the_post_thumbnail('minimag_477_500'); ?>
...
add_shortcode('minimag_carousel_three', 'minimag_carousel_three');
...
if( function_exists('vc_map') ) {
	...
	vc_map( array(
		'base' => 'minimag_carousel_three',
		'name' => esc_html__( 'Post Carousel 3', "minimag-toolkit" ),
		'class' => '',
