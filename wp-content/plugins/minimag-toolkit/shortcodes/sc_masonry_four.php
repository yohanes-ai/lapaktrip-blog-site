<?php
function minimag_masonry_four( $atts ) {
					...
					<div class="row blog-masonry-list">
						...
						while ( have_posts() ) : the_post();
							...
							if( $post_count == 1 || $post_count == 4 ) {
								$thumb = 'minimag_440_293';
							}
							elseif( $post_count == 2 ) {
								$thumb = 'minimag_440_660';
							}
							elseif( $post_count == 3 ||  $post_count == 7 ) {
								$thumb = 'minimag_440_440';
							}
							elseif( $post_count == 5) {
								$thumb = 'minimag_440_589';
							}
							elseif( $post_count == 6) {
								$thumb = 'minimag_440_580';
							}
							else {
								$thumb = 'minimag_440_294';
							}
							?>
							<div class="col-lg-6 col-md-6 col-sm-6 blog-masonry-box 1">
								<div <?php post_class(); ?>>
									<?php
...
add_shortcode('minimag_masonry_four', 'minimag_masonry_four');
...
if( function_exists('vc_map') ) {
	...
	vc_map( array(
		'base' => 'minimag_masonry_four',
		'name' => esc_html__( 'Masonry 4', "minimag-toolkit" ),
		'class' => '',
