<?php
function minimag_carousel_one( $atts ) {
				...
				<div class="carousel-inner" role="listbox">
					<?php
						...
						while ( $qry->have_posts() ) : $qry->the_post();
							...
							if($post_count  == 2){
								?> <div class="col-lg-4 col-sm-12 post-block post-thumb"> <?php	
							}
								?>
								<div class="post-box <?php echo $post_count; ?>">
									<?php
									if($post_count == 1) {
										the_post_thumbnail('minimag_770_500');
									}
									else {
										the_post_thumbnail('minimag_396_248');
									}
									?>
...
add_shortcode('minimag_carousel_one', 'minimag_carousel_one');
...
if( function_exists('vc_map') ) {
	...
	vc_map( array(
		'base' => 'minimag_carousel_one',
		'name' => esc_html__( 'Post Carousel 1', "minimag-toolkit" ),
		'class' => '',
